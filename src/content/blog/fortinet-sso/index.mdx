...
In our [previous post↪](/blog/gns3), we discussed and set up the network topology using GNS3. This time, we'll dive into configuring Fortinet Single Sign-On (FSSO) to enhance our network security and streamline user authentication.
