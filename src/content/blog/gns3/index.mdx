---
title: "GNS3 Enterprise Network Lab Simulation"
description: 'Full Enterprise Network Lab setup with complex topology, routing, NAT, firewalls etc.'
date: 2024-11-21
tags: ['devops', 'lab']
image: './arpa.png'
...
import TwoImg from './topology.png';
import OneImg from './backupLJ.png';
import ThreeImg from './isp1.png';
import FourImg from './isp2.png';
import FiveImg from './LJconfig.png';
import SixImg from './LJrouting.png';
import SevenImg from './mikrotik.png';
import EightImg from './policyLJ.png';
import NineImg from './policySB.png';
import TenImg from './primaryLJ.png';
import ElevenImg from './SBprimary.png';

## Introduction 
### Setting Up a Virtual Lab for Cybersecurity Projects

These are my notes for setting up a full functional enterprise network in a VM setting.

It covers the steps for configuring routing and other fundamental settings to ensure a smooth and functional virtual lab. By the end of this lab, you'll have a solid foundation to build upon as I go into advanced firewall configurations and security strategies in the upcoming posts.

<Callout variant="note">
This Lab series assumes that you have at least some knowledge of Networking and Computers in general.
</Callout>
...
<Image src={FiveImg} alt="FortiGateLJconfig" />
...
<Image src={SixImg} alt="FortiGateLJrouting" />
...
<Image src={OneImg} alt="FortiGateLJconfig" />
<Image src={TwoImg} alt="FortiGateLJconfig" />
...
<Image src={ThreeImg} alt="FortiGateLJconfig"/>
...
<Image src={FourImg} alt="FortiGateLJconfig"/>
<Image src={FiveImg} alt="FortiGateLJconfig"/>
...
<Image src={SixImg} alt="MikrotikRouting"/>
...
<Image src={SevenImg} alt="FortiGateLJPolicies"/>
...
<Image src={EightImg} alt="FortiGateSBPolicies"/>
